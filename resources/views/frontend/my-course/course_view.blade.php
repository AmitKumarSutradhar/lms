@include('frontend.my-course.includes.header')
<body>
                                    ...
                                    <div class="new-question-wrap">
                                        ...
                                        <div class="new-question-body pt-40px">
                                            ...
                                            <form action="{{ route('user.question') }}" method="POST" class="pt-4">
                                                ...
                                                <input type="hidden" name="instructor_id" id="" value="{{ $course->instructor_id }}">
                                                <div class="custom-control-wrap">
                                                    <div class="custom-control custom-radio mb-3 pl-0">
                                                        <input type="text" name="subject" class="form-control form--control pl-3" placeholder="Subject: Question about.....">
                                                    </div>
                                                    <div class="custom-control custom-radio mb-3 pl-0">
                                                        <textarea class="form-control form--control pl-3" name="question" id="" cols="30" rows="10" placeholder="Enter your comment...."></textarea>
                                                    </div>
                                                </div>
                    ...
                    <div class="course-dashboard-side-content">
                        <div class="accordion generic-accordion generic--accordion" id="accordionCourseExample">
                            @foreach($section as $sec)
                                ...
                                <div id="collapseOne{{ $sec->id }}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionCourseExample">
                                    <div class="card-body p-0">
                                        <ul class="curriculum-sidebar-list">
...
@include('frontend.my-course.includes.footer')
</body>
</html>
