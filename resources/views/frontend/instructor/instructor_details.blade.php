                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="counter-item">
                            ...
                            <h4 class="counter__title counter text-color-4 fs-35">{{ count($course) }}</h4>
    ...
    <section class="course-area section-padding">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between pb-3">
                ...
                <span class="ribbon ribbon-lg">{{ count($course) }}</span>
            </div>
            <div class="divider"><span></span></div>
            <div class="row pt-30px">
                @foreach($course as $item)
                    <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{$item->id}}">
                        <div class="card-image">
                            <a href="{{ url('course/details/'.$item->id.'/'.$item->course_name_slug) }}" class="d-block">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><a href="{{ url('/course/details/'.$item->id.'/'.$item->course_name_slug) }}">The Business Intelligence Analyst Course 2021</a></h5>
                            <p class="card-text"><a href="{{ route('instructor.details',$item->instructor_id) }}">{{ $item['user']['name'] }}</a></p>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                @if($item->discount_price == NULL)
                                    <p class="card-price text-black font-weight-bold">${{ $item->selling_price }}</p>
                                @else
            ...
            <div id="tooltip_content_1{{ $item->id }}">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        @php
                            $goals = \App\Models\CourseGoal::where('course_id',$item->id)->orderBy('id','DESC')->get();
                        @endphp
