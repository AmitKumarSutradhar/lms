            ...
            <div class="row pt-50px">
                <div class="col-lg-10 mx-auto">
                    <div class="card card-item">
                        <div class="card-body">
                            <form action="{{ route('instructor.register') }}" method="post" class="row">
                                @csrf
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('username') is-invalid @enderror" type="text" name="username" placeholder="e.g. Alex">
                                        <span class="la la-user input-icon"></span>
                                        @error('username')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('phone') is-invalid @enderror" type="text" name="phone" placeholder="e.g. +88 0123456789">
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control @error('email') is-invalid @enderror" type="email" name="email" placeholder="e.g. Alex">
                                        <span class="la la-user input-icon"></span>
                                        @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="input-box col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control " type="password" name="password" placeholder="e.g. Alex">
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <textarea name="address" class="form-control form--control @error('address') is-invalid @enderror" name="" id="" cols="30" rows="10" style="width: 100%;"></textarea>
