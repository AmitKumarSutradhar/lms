                        ...
                        <div class="course-overview-card">
                            <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                                ...
                                <div class="curriculum-duration fs-15">
                                    ...
                                    <span class="curriculum-total__hours"><strong class="text-black font-weight-semi-bold">Total hours:</strong> {{ $course->duration }} hrs</span>
                                </div>
                            </div>
                            ...
                            <div class="curriculum-content">
                                <div id="accordion" class="generic-accordion">
                                    @foreach($section as $item)
                                        ...
                                        @php
                                            $lecture = \App\Models\CourseLecture::where('section_id',$item->id)->get();
                                        @endphp
                                ...
                                <div class="media media-card align-items-center">
                                    <div class="review-rating-summary">
                                        ...
                                        <div class="rating-wrap pt-1">
                                            ...
                                            <span class="rating-total d-block">({{ $reviewCount->count() }})</span>
                                    ...
                                    <div class="media-body">
                                        @php
                                            $reviewcount = \App\Models\Review::where('course_id',$course->id)
                                                                            ->where('status',1)
                                                                            ->select('rating', \Illuminate\Support\Facades\DB::raw('count(*) as count'))->groupBy('rating')
                        ...
                        @guest
                            <div class="course-overview-card pt-4">
                                ...
                                <form action="{{ route('store.review') }}" method="post" class="row">
                                    ...
                                    <div class="btn-box col-lg-12">
                                        <button class="btn theme-btn" type="submit" disabled>Submit Review</button>
                                    </div><!-- end btn-box -->
                                </form>
                            </div><!-- end course-overview-card -->
                        @else
                    ...
                    @foreach($instructorCourses as $inscourse)
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                @else
                                    <p class="card-price text-black font-weight-bold">${{ $inscourse->discount_price }} <span class="before-price font-weight-medium">${{ $course->selling_price }}</span></p>
                                @endif
                ...
                <div class="modal-body">
                    <div class="copy-to-clipboard">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form--control copy-input pl-3" value="{{ route('index').'/'.Request::path() }}">
                            <div class="input-group-append">
