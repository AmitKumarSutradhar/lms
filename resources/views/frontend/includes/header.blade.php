                ...
                <div class="col-lg-6">
                    <div class="header-widget">
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14">
                            <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-phone mr-1"></i><a href="tel:{{ $setting->phone }}"> (+88) {{ $setting->phone }}</a></li>
                ...
                <div class="col-lg-6">
                    <div class="header-widget d-flex flex-wrap align-items-center justify-content-end">
                        ...
                        <ul class="generic-list-item d-flex flex-wrap align-items-center fs-14 border-left border-left-gray pl-3 ml-3">
                            ...
                            @else
                                <li class="d-flex align-items-center pr-3 mr-3 border-right border-right-gray"><i class="la la-sign-in mr-1"></i><a href="{{ route('login') }}"> Log In</a></li>
...
{{--                            <h3><b class="text-bg-dark"> <a href="{{route('index')}}">Edu-Squar</a></b></h3>--}}
                                    ...
                                    <li>
                                        ...
                                        <ul class="cat-dropdown-menu">
                                            @foreach($categories as $item)
                                                ...
                                                @php
                                                    $subCategories = \App\Models\SubCategory::where('category_id',$item->id)->get();
                                                @endphp

                                                <li>
                                                    <a href="{{ url('category/'.$item->id.'/'.$item->category_slug) }}">{{ $item->category_name }} <i class="la la-angle-right"></i></a>
                                                    <ul class="sub-menu">
                                                        <li><a href="#">All {{ $item->category_name }}</a></li>
                                                        @foreach($subCategories as $subitem)
                                                            <li><a href="{{ url('subcategory/'.$subitem->id.'/'.$subitem->subcategory_slug) }}">{{ $subitem->subcategory_name }}</a></li>
                                                        @endforeach
                                                    </ul>
                                                </li>
                                            @endforeach
                                    ...
                                    <li>
                                        ...
                                        <ul class="cart-dropdown-menu">
                                            ...
                                            <li class="media media-card">
                                                <div class="media-body fs-16 pt-3">
                                                    <p class="text-black font-weight-semi-bold lh-18">Total: $<span class="cart-total" id="cartSubTotal"></span> <span class="before-price fs-14"></span></p>
                                                </div>
                                            </li>
                                            <li>
