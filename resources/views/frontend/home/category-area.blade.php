            ...
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{ asset('/') }}frontend/images/img-loading.png" data-src="{{ asset('/') }}frontend/images/img1.jpg" alt="Category image">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{ asset('/') }}frontend/images/img-loading.png" data-src="{{ asset('/') }}frontend/images/img2.jpg" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{ asset('/') }}frontend/images/img-loading.png" data-src="{{ asset('/') }}frontend/images/img3.jpg" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{ asset('/') }}frontend/images/img-loading.png" data-src="{{ asset('/') }}frontend/images/img4.jpg" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{ asset('/') }}frontend/images/img-loading.png" data-src="{{ asset('/') }}frontend/images/img5.jpg" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{ asset('/') }}frontend/images/img-loading.png" data-src="{{ asset('/') }}frontend/images/img6.jpg" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
