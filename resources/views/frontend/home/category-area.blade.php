            ...
            <div class="row">
                @foreach($category as $item)
                    ...
                    <div class="category-item">
                        <img  class="cat__img lazy" src="{{ asset($item->image) }}" data-src="{{ asset($item->image) }}" alt="{{ $item->category_name }}">
                        <div class="category-content">
                            <div class="category-inner">
                                ...
                                <a href="{{ url('category/'.$item->id.'/'.$item->category_slug) }}" class="btn theme-btn theme-btn-sm theme-btn-white">Explore<i class="la la-arrow-right icon ml-1"></i></a>
                            </div>
