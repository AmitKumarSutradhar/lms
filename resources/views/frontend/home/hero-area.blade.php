<section class="hero-area">
    <div class="hero-slider owl-action-styled">
        @php
            $banners = \App\Models\Banner::where('is_active',1)->limit(3)->orderBy('position','DESC')->get();
        @endphp

        @foreach($banners as $item)
{{--            <div class="hero-slider-item hero-bg-1">--}}
            <div class="hero-slider-item" style="background-image: url( {{$item->image_url}}); background-repeat: no-repeat; background-size: cover">
                <div class="container">
                    <div class="hero-content">
                        <div class="section-heading">
                            <h2 class="section__title text-white fs-65 lh-80 pb-3">{{$item->title_one}} <br> {{$item->title_two}}</h2>
